...
<script>
  ...
  async function update(tree) {
    if ('@bookmarkBar' in tree) {
      ...
      await monolith.sendInternal('userData', 'bookmarks:addFolder', { folder: '@bookmarkBar' })
    }
  }
...
{#if $config?.ui.showBookmarks && !['mth://bookmarks', 'mth://bookmarks/'].includes(pageURL)}
