/* src\browser\mth\$svelte\src\Settings\dialogs\DataClearer.svelte generated by Svelte v3.48.0 */
import {
	SvelteComponentDev,
	add_flush_callback,
	add_location,
...
const file = "src\\browser\\mth\\$svelte\\src\\Settings\\dialogs\\DataClearer.svelte";

// (60:2) <Checkbox bind:checked={clear.cache}>
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(60:2) <Checkbox bind:checked={clear.cache}>",
		ctx
	});
...
// (61:2) <Checkbox bind:checked={clear.cookies}>
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(61:2) <Checkbox bind:checked={clear.cookies}>",
		ctx
	});
...
// (62:2) <Checkbox bind:checked={clear.storages}>
function create_default_slot_7(ctx) {
	let t;

	const block = {
		c: function create() {
			t = text("Databases and local storage");
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(62:2) <Checkbox bind:checked={clear.storages}>",
		ctx
	});
...
// (63:2) <Checkbox bind:checked={clear.history}>
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(63:2) <Checkbox bind:checked={clear.history}>",
		ctx
	});
...
// (64:2) <Checkbox bind:checked={clear.downs}>
function create_default_slot_5(ctx) {
	let t;

	const block = {
		c: function create() {
			t = text("All downloads");
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(64:2) <Checkbox bind:checked={clear.downs}>",
		ctx
	});
...
function create_default_slot_4(ctx) {
	...
	const block = {
		c: function create() {
			t = text("The pages for history and downloads provide more control over what to clear.");
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
		},
...
// (68:2) <Checkbox bind:checked={clear.siteSettings}>
function create_default_slot_3(ctx) {
	let t;

	const block = {
		c: function create() {
			t = text("Site permissions");
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(68:2) <Checkbox bind:checked={clear.siteSettings}>",
		ctx
	});
...
// (59:0) <ContentDialog size="max" title="Choose what to erase" append={document.body} bind:open closable={false}>
function create_default_slot_2(ctx) {
	...
	function checkbox0_checked_binding(value) {
		/*checkbox0_checked_binding*/ ctx[6](value);
	}
	...
	function checkbox1_checked_binding(value) {
		/*checkbox1_checked_binding*/ ctx[7](value);
	}
	...
	function checkbox2_checked_binding(value) {
		/*checkbox2_checked_binding*/ ctx[8](value);
	}
	...
	function checkbox3_checked_binding(value) {
		/*checkbox3_checked_binding*/ ctx[9](value);
	}
	...
	function checkbox4_checked_binding(value) {
		/*checkbox4_checked_binding*/ ctx[10](value);
	}
	...
	function checkbox5_checked_binding(value) {
		/*checkbox5_checked_binding*/ ctx[11](value);
	}
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(59:0) <ContentDialog size=\\\"max\\\" title=\\\"Choose what to erase\\\" append={document.body} bind:open closable={false}>",
		ctx
	});
...
// (71:4) <Button on:click={() => open = false}>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(71:4) <Button on:click={() => open = false}>",
		ctx
	});
...
// (72:4) <Button on:click={clearSelected} variant="accent" disabled={isLoading}>
function create_default_slot(ctx) {
	let t_value = (/*isLoading*/ ctx[1] ? "Loading..." : "Clear") + "";
	let t;
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*isLoading*/ 2 && t_value !== (t_value = (/*isLoading*/ ctx[1] ? "Loading..." : "Clear") + "")) set_data_dev(t, t_value);
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(t);
		}
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(72:4) <Button on:click={clearSelected} variant=\\\"accent\\\" disabled={isLoading}>",
		ctx
	});
...
// (70:2) <svelte:fragment slot="footer">
function create_footer_slot(ctx) {
	...
	button1.$on("click", /*clearSelected*/ ctx[4]);
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*$$scope, isLoading*/ 65538) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(70:2) <svelte:fragment slot=\\\"footer\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, isLoading, open, clear*/ 65543) {
