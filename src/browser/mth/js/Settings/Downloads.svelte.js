/* src\browser\mth\$svelte\src\Settings\Downloads.svelte generated by Svelte v3.48.0 */
import {
	SvelteComponentDev,
	add_flush_callback,
	add_location,
...
function create_default_slot_8(ctx) {
	...
	const block = {
		c: function create() {
			t = text("Save downloaded files to:");
		},
...
function create_default_slot_4(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*$config*/ 2 && t_value !== (t_value = (/*$config*/ ctx[1].behaviour.downloadPath ?? 'No path selected') + "")) set_data_dev(t, t_value);
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(t);
		}
...
function create_fragment(ctx) {
	...
	button0.$on("click", /*selectFolder*/ ctx[4]);
